    ...
    <div className="min-h-screen flex flex-col justify-between p-6 sm:p-12 bg-[#F5F6FC] dark:bg-[#14141A] text-center text-[#14141A] dark:text-[#F5F6FC] transition-colors duration-200">
      ...
      <div className="mx-auto max-w-md my-auto space-y-6">
        ...
        <div className="space-y-2">
          <h1 className="font-heading text-3xl font-black text-[#14141A] dark:text-[#F5F6FC] tracking-tight">
        ...
        <div className="flex items-center justify-center gap-4 pt-2">
          <button
            onClick={() => reset()}
            className="inline-flex items-center gap-2 rounded-2xl bg-[#374BFF] px-6 py-3 text-sm font-black text-white shadow-lg shadow-[#374BFF]/20 hover:bg-[#14141A] dark:hover:bg-[#CFFF04] dark:hover:text-[#14141A] hover:scale-105 transition-all cursor-pointer"
          >
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 rounded-2xl border border-[#14141A]/12 dark:border-white/15 bg-white dark:bg-[#1C1C26] px-6 py-3 text-sm font-bold text-[#14141A] dark:text-[#F5F6FC] hover:border-[#374BFF] transition-all"
          >
