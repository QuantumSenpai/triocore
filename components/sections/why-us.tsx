...
export function WhyUsSection({ initialStats }: WhyUsSectionProps) {
  const stats = (initialStats && initialStats.length > 0) ? initialStats : staticWhyUsStats;
 ...
 <div
 key={`${stat.label}-${i}`}
 className="flex-1 min-w-[135px] sm:min-w-[170px] md:min-w-[190px] max-w-[260px] flex flex-col justify-center items-center py-5 px-3 sm:py-6 sm:px-4 rounded-2xl bg-white/[0.04] border border-white/10 hover:border-[#374BFF] hover:bg-white/[0.07] transition-all"
 >
 ...
 <span className="mx-1 sm:mx-1.5 text-xl sm:text-3xl lg:text-4xl font-light text-[#374BFF] opacity-85 select-none">/</span>
