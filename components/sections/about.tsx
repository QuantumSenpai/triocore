...
export function AboutSection() {
 ...
 <span
 key={tag}
 className="rounded-full border border-[#14141A] bg-white px-3.5 sm:px-4.5 py-1.5 sm:py-2 text-xs sm:text-sm font-bold text-[#14141A] shadow-sm transition-all interactive-lift hover:border-[#374BFF] hover:text-[#374BFF]"
 >
 {tag}
 </span>
 ))}
 ...
 <h3 className="mt-2 text-2xl sm:text-4xl font-black font-heading tracking-tight text-[#14141A]">
 ...
 <p className="text-xs text-[#2B2B38] leading-relaxed font-sans font-medium">
 {item.desc}
 </p>
 </div>
 </div>
