...
export function HeroSection({ initialData }: HeroSectionProps) {
 ...
 <Link
 href="#pricing"
 className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-2xl bg-[#374BFF] px-8 py-3.5 sm:py-4 text-sm sm:text-base font-bold text-white shadow-xl shadow-[#374BFF] transition-all duration-300 hover:bg-[#14141A] hover:shadow-2xl interactive-lift  focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#374BFF]"
 >
 ...
 <Link
 href="#showcase"
 className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-2xl border-2 border-[#14141A] bg-white px-8 py-3.5 sm:py-4 text-sm sm:text-base font-bold text-[#14141A] transition-all duration-300 hover:border-[#374BFF] hover:text-[#374BFF] interactive-lift  shadow-md shadow-black/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#374BFF]"
 >
 ...
 <div
 key={stat.key}
 className="glass-card rounded-3xl p-6 text-center border border-[#14141A] hover:-translate-y-1.5 transition-transform duration-300"
 >
 ...
 <CheckCircle2 className="h-4 w-4 text-[#374BFF]" /> 100% Tailored Code
 </span>
 <span className="inline-flex items-center gap-1.5">
 <CheckCircle2 className="h-4 w-4 text-[#374BFF]" /> 48-Hour Prototyping
 </span>
 <span className="inline-flex items-center gap-1.5">
