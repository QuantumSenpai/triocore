...
export function ServicesBentoSection({ initialServices }: ServicesBentoSectionProps) {
 ...
 <span className="text-[10px] font-black uppercase tracking-wider px-3 py-1 rounded-full border border-[#14141A] bg-[#14141A] text-[#14141A] shadow-sm">
 {service.badge}
 </span>
 </div>
 ...
 <div className="space-y-2.5 pt-2 border-t border-[#14141A] ">
 ...
 <div className="pt-5 sm:pt-6 mt-5 sm:mt-6 border-t border-[#14141A] flex items-center justify-between">
 <Link
 href="#pricing"
