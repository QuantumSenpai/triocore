...
export function RoadmapSection() {
 ...
 <div className="hidden lg:block absolute top-12 left-4 right-4 h-2 -translate-y-1/2 rounded-full bg-[#14141A] z-0 overflow-hidden">
 <motion.div
 initial={{ width: "0%" }}
 ...
 <div className="lg:hidden absolute top-6 bottom-20 left-1/2 -translate-x-1/2 w-2 rounded-full bg-[#14141A] z-0 overflow-hidden">
 <motion.div
 initial={{ height: "0%" }}
 ...
 <div>
 <h3 className="font-heading text-lg sm:text-xl font-bold tracking-tight text-[#14141A]">
 {node.title}
 </h3>
 </div>
 ...
 <Target className="h-4 w-4 text-[#374BFF] shrink-0 mt-0.5" />
 )}
 <span
 className={
 m.status === "completed"
 ...
 <div className="pt-5 sm:pt-6 mt-5 sm:mt-6 border-t border-[#14141A] flex items-center justify-between text-xs font-bold text-[#14141A]">
 <span className="flex items-center gap-1.5 text-[#14141A] ">
