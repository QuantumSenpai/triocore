...
export function InnovationLabSection() {
 ...
 <div className="space-y-3 pt-3 border-t border-[#14141A] ">
 ...
 <span
 key={t}
 className="text-[10px] font-bold px-2.5 py-0.5 rounded-md border border-[#14141A] bg-[#F5F6FC] text-[#14141A]"
 >
 {t}
 </span>
 ))}
 ...
 <div className="pt-4 sm:pt-5 mt-4 sm:mt-5 border-t border-[#14141A] flex items-center justify-between text-xs font-bold text-[#14141A] ">
